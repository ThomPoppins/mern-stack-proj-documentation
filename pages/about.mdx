...
It has been a couple of months since I started this journey, and it hasn't ended. I've tried many different approaches to building a React.js application, and I am still learning new things every day. My learning journey wasn't perfect at all; I was a little overwhelmed by all the possibilities with React and JavaScript, spending too much time finding out about tooling for setting up an application. I delved into Next.js and Gatsby because they offered more than basic React.

#### The Side Track

After a while, I began to notice that having extra support from tools and packages and functionalities from a framework were not always liberating but also began to feel restricting. It gave me the feeling of wanting to hack into the framework to get things done the way I wanted. Luckily, I stumbled onto a YouTube tutorial that showed me that working strictly with React is possible to create a functional website with routing, pages, and all the freedom to do whatever I could think of, without the need to follow a certain framework's way. Next.js and Gatsby were awesome for learning, but I felt that I missed out on time that could have been spent learning how to customize an application perfectly to my own needs and wishes.

That's the stage I'm at now, trying to construct an application that will do anything I can think of. I have an issues page on the bottom of the left navigation menu; it's the list of Jira issues I created for myself to keep track of what I want to do and what I have done. I have taken very little effort to phrase my sentences well because noting down an idea usually occurs when I am busy working on something else that has to wait; otherwise, I might forget about or get distracted from it. Still, I think it's worth the effort because it starts to become like a library of cool stuff I deemed possible to be very cool, like a collection of future material. If something is very cool, interesting, or useful, I might write about it on this website.
...
Since I read an article about the MERN stack, I felt like this is everything I need to be able to eventually reach any goal I'd set for myself and decided to start a big project this time. A huge idea, not even possible to maintain this application by myself if it would get the traffic with handling enormous amounts of data together with lots of functionalities that have to stay compatible also after updates. So why would I start a project like that?

#### Conclusion

The reason I make the decision to start working on an application with a goal far and fat away is because this is what I want to do. I like customizing, building something from the ground up the way I have thought of. Of course, I change my mind a lot because I am still in the learning phase, and in the future, I will be able to weigh the pros and cons of decisions even better. Still, I am on a pretty stable place with everything the MERN stack has to offer.

#### Final Greetings

You made it this far, thank you for your interest and taking your time to read my story. I hope this website is of enjoyment to you and that you will find something useful here!
